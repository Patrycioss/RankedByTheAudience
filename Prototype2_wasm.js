...
var TextInput = {
  ...
  addEventToQueue: function addEventToQueue(id, name, value) {
    if (TextInput.list[id]) {
      ...
      getWasmTableEntry(AddToCommandQueue)(id, name, cstr);
      _free(cstr);
    }
  },
...
function _JS_TextInput_clearFocus(id) {
  if (TextInput.list[id]) {
    var data = TextInput.list[id];
    data.field.blur();
  }
}
function _JS_TextInput_create(isHidden) {
...
function _JS_TextInput_focus(id) {
  if (TextInput.list[id]) {
    var data = TextInput.list[id];
...
function _JS_TextInput_getText(id) {
  if (TextInput.list[id]) {
    var data = TextInput.list[id];
...
function _JS_TextInput_initialize(c_AddToCommandQueue) {
  ...
  if (TextInput.isMobile() && !("virtualKeyboard" in navigator && window.location.protocol == "https:")) {
    ...
    container.addEventListener("touchstart", function (ev) {
      ...
      touchstartEvent = (_ev$originalEvent = ev.originalEvent) !== null && _ev$originalEvent !== void 0 ? _ev$originalEvent : ev;
    });
...
function _JS_TextInput_remove(id) {
  if (TextInput.list[id]) {
    var data = TextInput.list[id];
    if (data.cstr_text) _free(data.cstr_text);
...
function _JS_TextInput_setAutoCapitalize(id, autoCapitalize) {
  if (TextInput.list[id]) {
    var data = TextInput.list[id];
...
function _JS_TextInput_setMaxLength(id, maxLength) {
  if (TextInput.list[id]) {
    var data = TextInput.list[id];
    data.field.setAttribute("maxlength", maxLength);
  }
}
function _JS_TextInput_setPosition(id, x, y) {
  if (TextInput.list[id]) {
    var data = TextInput.list[id];
    if (!data.isHidden) {
...
function _JS_TextInput_setReturnKeyType(id, returnKeyType) {
  if (TextInput.list[id]) {
    var data = TextInput.list[id];
...
function _JS_TextInput_setSize(id, width, height) {
  if (TextInput.list[id]) {
    var data = TextInput.list[id];
    if (!data.isHidden) {
...
function _JS_TextInput_setText(id, text) {
  if (TextInput.list[id]) {
    var data = TextInput.list[id];
    data.field.value = UTF8ToString(text);
  }
}
function _JS_TextInput_setTextColor(id, color) {
  if (TextInput.list[id] && !TextInput.list[id].isHidden) {
    var data = TextInput.list[id];
    data.field.style.color = UTF8ToString(color);
  }
}
function _JS_TextInput_setTextSize(id, size) {
  if (TextInput.list[id] && !TextInput.list[id].isHidden) {
    var data = TextInput.list[id];
    data.field.style.fontSize = size + "px";
  }
}
function _JS_TextInput_setVisible(id, visible) {
  if (TextInput.list[id]) {
    var data = TextInput.list[id];
...
var wasmImports = {
  oi: _JS_TextInput_clearFocus,
  ni: _JS_TextInput_create,
  mi: _JS_TextInput_focus,
  li: _JS_TextInput_getText,
  ki: _JS_TextInput_initialize,
  ji: _JS_TextInput_remove,
  ii: _JS_TextInput_setAutoCapitalize,
  hi: _JS_TextInput_setHint,
  gi: _JS_TextInput_setHintTextColor,
  fi: _JS_TextInput_setKeyboardType,
  ei: _JS_TextInput_setMaxLength,
  di: _JS_TextInput_setPosition,
  ci: _JS_TextInput_setReturnKeyType,
  bi: _JS_TextInput_setSize,
  ai: _JS_TextInput_setText,
  $h: _JS_TextInput_setTextColor,
  _h: _JS_TextInput_setTextSize,
  Zh: _JS_TextInput_setVisible,
  b: ___assert_fail,
...
var _wasm_call_ctors = function ___wasm_call_ctors() {
  return (_wasm_call_ctors = wasmExports["pi"])();
};
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function () {
  return (_dmExportedSymbols = Module["_dmExportedSymbols"] = wasmExports["qi"])();
};
var _main = Module["_main"] = function (a0, a1) {
  return (_main = Module["_main"] = wasmExports["ri"])(a0, a1);
};
var _malloc = Module["_malloc"] = function (a0) {
  return (_malloc = Module["_malloc"] = wasmExports["si"])(a0);
};
var _free = Module["_free"] = function (a0) {
  return (_free = Module["_free"] = wasmExports["ti"])(a0);
};
var _htonl2 = function _htonl(a0) {
  return (_htonl2 = wasmExports["vi"])(a0);
};
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function (a0) {
  return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = wasmExports["wi"])(a0);
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function () {
  return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = wasmExports["xi"])();
};
var _setTempRet = function setTempRet0(a0) {
  return (_setTempRet = wasmExports["yi"])(a0);
};
var _htons2 = function _htons(a0) {
  return (_htons2 = wasmExports["zi"])(a0);
};
